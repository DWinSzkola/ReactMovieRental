...
const WelcomePage = () =>{
    ...
    return <div className="backgroundWelcomePage">
            ...
            <Row style={{height:"100%"}}>
                <Col className="menuWelcomePage d-flex align-items-center">
                    <div className="container-fluid-xs container-lg">
                        <Row>
                            <Col xs={12} className="d-flex"  style={{cursor:"default"}}>
                                <div ref={logoRef} 
                                style={
                                    {
                            ...
                            style={
                                {
                                    transform: areButtonsInView ? "translateY(0)" : "translateY(100px)",
                                    opacity: areButtonsInView ? 1 : 0,
                                    transition: "1s" 
                                    }
                                }>
                                <Link to="/movies"><Button className=" rounded-5">Go Search a Movie</Button></Link>
                                <Button className="rounded-5 signInButton">Sing in</Button>
                            </div>
